-- 回滚只恢复旧默认值；现有行和约束保持不变。
CREATE TABLE tenant_api_keys_default_scope (
...
INSERT INTO tenant_api_keys_default_scope (
...
ALTER TABLE tenant_api_keys_default_scope RENAME TO tenant_api_keys;
