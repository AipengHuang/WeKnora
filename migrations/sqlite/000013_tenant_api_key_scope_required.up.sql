-- SQLite 不支持直接删除列默认值，因此按官方表重建流程保留所有行和约束。
CREATE TABLE tenant_api_keys_explicit_scope (
...
INSERT INTO tenant_api_keys_explicit_scope (
...
ALTER TABLE tenant_api_keys_explicit_scope RENAME TO tenant_api_keys;
